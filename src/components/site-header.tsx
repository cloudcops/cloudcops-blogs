          ...
          <div className="flex flex-col space-y-1 px-4 py-4">
            ...
            <div className="pt-4 mt-2 border-t border-white/10">
              <a
                ...
                rel="noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
              >
                <Calendar className="h-4 w-4" />
                Book a Meeting
              </a>
